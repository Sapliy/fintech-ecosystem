...
const (
	...
	PaymentService_ConfirmPaymentIntent_FullMethodName = "/payments.PaymentService/ConfirmPaymentIntent"
	PaymentService_RefundPaymentIntent_FullMethodName  = "/payments.PaymentService/RefundPaymentIntent"
)
...
type PaymentServiceClient interface {
	...
	RefundPaymentIntent(ctx context.Context, in *RefundPaymentIntentRequest, opts ...grpc.CallOption) (*PaymentIntent, error)
}
...
func (c *paymentServiceClient) RefundPaymentIntent(ctx context.Context, in *RefundPaymentIntentRequest, opts ...grpc.CallOption) (*PaymentIntent, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PaymentIntent)
	err := c.cc.Invoke(ctx, PaymentService_RefundPaymentIntent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServiceServer interface {
	...
	RefundPaymentIntent(context.Context, *RefundPaymentIntentRequest) (*PaymentIntent, error)
...
func (UnimplementedPaymentServiceServer) RefundPaymentIntent(context.Context, *RefundPaymentIntentRequest) (*PaymentIntent, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RefundPaymentIntent not implemented")
}
...
func _PaymentService_RefundPaymentIntent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RefundPaymentIntentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).RefundPaymentIntent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_RefundPaymentIntent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).RefundPaymentIntent(ctx, req.(*RefundPaymentIntentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PaymentService_RefundPaymentIntent_Handler,
		},
	},
